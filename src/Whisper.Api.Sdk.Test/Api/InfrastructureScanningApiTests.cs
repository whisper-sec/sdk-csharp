...
{
    /// <summary>
    ///  Class for testing InfrastructureScanningApi
    /// </summary>
    public sealed class InfrastructureScanningApiTests : ApiTestsBase
    {
        private readonly IInfrastructureScanningApi _instance;

        public InfrastructureScanningApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IInfrastructureScanningApi>();
        }
