...
{
    /// <summary>
    ///  Class for testing AIIntelligenceApi
    /// </summary>
    public sealed class AIIntelligenceApiTests : ApiTestsBase
    {
        private readonly IAIIntelligenceApi _instance;

        public AIIntelligenceApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IAIIntelligenceApi>();
        }
