...
namespace Whisper.Api.Sdk.Test.Api
{
    ...
    public sealed class LocationApiTests : ApiTestsBase
    {
        ...
        {
            BulkIpLocationRequest bulkIpLocationRequest = default;
            await _instance.GetBulkIpLocationAsync(bulkIpLocationRequest);
        }
        ...
        public async Task GetIpLocationAsyncTest()
        {
            ...
            Assert.IsType<IpGeolocationResponse>(model);
        }
        ...
        {
            string cidr = default;
            await _instance.GetNetworkLocationAsync(cidr);
        }
