...
namespace Whisper.Api.Sdk.Test.Api
{
    ...
    public sealed class OperationsApiTests : ApiTestsBase
    {
        ...
        {
            Object body = default!;
            var response = await _instance.CreateInfrastructureMapAsync(body);
        ...
        {
            InfraScanRequest infraScanRequest = default!;
            var response = await _instance.CreateInfrastructureScanAsync(infraScanRequest);
        ...
        public async Task CreateMonitoringAlertAsyncTest()
        {
            ...
            Object body = default!;
            var response = await _instance.CreateMonitoringAlertAsync(target, body);
            var model = response.Accepted();
            Assert.IsType<JobResponse>(model);
        }
        ...
        public async Task GetChangeDetectionAsyncTest()
        {
            ...
            var response = await _instance.GetChangeDetectionAsync(target, type, since);
            var model = response.BadRequest();
            Assert.IsType<ErrorResponse>(model);
        }
