...
{
    /// <summary>
    ///  Class for testing ChangeTrackingApi
    /// </summary>
    public sealed class ChangeTrackingApiTests : ApiTestsBase
    {
        private readonly IChangeTrackingApi _instance;

        public ChangeTrackingApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IChangeTrackingApi>();
        }
        ...
        public async Task GetChangesAsyncTest()
        {
            ...
            Assert.IsType<ChangeTrackingResponse>(model);
        }
        ...
        public async Task ListTrackedIndicatorsAsyncTest()
        {
            ...
            var model = response.Ok();
            Assert.IsType<TrackedIndicatorsResponse>(model);
        }
        ...
        public async Task StopChangeTrackingAsyncTest()
        {
            ...
            var response = await _instance.StopChangeTrackingAsync(type, value, deleteHistory);
            var model = response.Ok();
