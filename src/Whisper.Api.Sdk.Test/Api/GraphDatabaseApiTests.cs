...
{
    /// <summary>
    ///  Class for testing GraphDatabaseApi
    /// </summary>
    public sealed class GraphDatabaseApiTests : ApiTestsBase
    {
        private readonly IGraphDatabaseApi _instance;

        public GraphDatabaseApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IGraphDatabaseApi>();
        }

        /// <summary>
        /// Test ExecuteCypherQuery
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ExecuteCypherQueryAsyncTest()
        {
            string authorization = default;
            CypherQueryRequest cypherQueryRequest = default;
            var response = await _instance.ExecuteCypherQueryAsync(authorization, cypherQueryRequest);
            var model = response.Ok();
            Assert.IsType<CypherQueryResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ExecuteGraphQLAsyncTest()
        {
            string authorization = default;
            GraphQLRequest graphQLRequest = default;
            await _instance.ExecuteGraphQLAsync(authorization, graphQLRequest);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetGraphiQLAsyncTest()
        {
            await _instance.GetGraphiQLAsync();
        }
        ...
        {
            string authorization = default;
            var response = await _instance.GetSchemaAsync(authorization);
            var model = response.Ok();
            Assert.IsType<CypherSchemaResponse>(model);
        }
    }
}
