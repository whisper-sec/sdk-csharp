...
namespace Whisper.Api.Sdk.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is DnsEnumConfig.WordlistSizeEnum dnsEnumConfigWordlistSizeEnum)
                return DnsEnumConfig.WordlistSizeEnumToJsonValue(dnsEnumConfigWordlistSizeEnum);
            ...
            if (obj is InfraScanRequest.TargetTypeEnum infraScanRequestTargetTypeEnum)
                return InfraScanRequest.TargetTypeEnumToJsonValue(infraScanRequestTargetTypeEnum);
            if (obj is InfraScanRequest.ScanDepthEnum infraScanRequestScanDepthEnum)
                return InfraScanRequest.ScanDepthEnumToJsonValue(infraScanRequestScanDepthEnum);
            if (obj is Job.StatusEnum jobStatusEnum)
                return Job.StatusEnumToJsonValue(jobStatusEnum);
            if (obj is PortScanConfig.TechniqueEnum portScanConfigTechniqueEnum)
                return PortScanConfig.TechniqueEnumToJsonValue(portScanConfigTechniqueEnum);
