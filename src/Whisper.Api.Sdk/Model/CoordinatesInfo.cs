...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class CoordinatesInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoordinatesInfo" /> class.
        /// </summary>
        /// <param name="latitude">Latitude coordinate</param>
        /// <param name="longitude">Longitude coordinate</param>
        [JsonConstructor]
        public CoordinatesInfo(Option<double?> latitude = default, Option<double?> longitude = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="CoordinatesInfo" />
    /// </summary>
    public class CoordinatesInfoJsonConverter : JsonConverter<CoordinatesInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="CoordinatesInfo" />
        /// </summary>
        ...
        public override CoordinatesInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class CoordinatesInfo.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class CoordinatesInfo.");

            return new CoordinatesInfo(latitude, longitude);
        }

        /// <summary>
        /// Serializes a <see cref="CoordinatesInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="coordinatesInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CoordinatesInfo coordinatesInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, coordinatesInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CoordinatesInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="coordinatesInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CoordinatesInfo coordinatesInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (coordinatesInfo.LatitudeOption.IsSet)
                writer.WriteNumber("latitude", coordinatesInfo.LatitudeOption.Value.Value);

            if (coordinatesInfo.LongitudeOption.IsSet)
                writer.WriteNumber("longitude", coordinatesInfo.LongitudeOption.Value.Value);
        }
    }
}
