...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class TrackedIndicatorsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedIndicatorsResponse" /> class.
        /// </summary>
        /// <param name="count">Total number of tracked indicators</param>
        /// <param name="maxTracked">Maximum number of indicators that can be tracked per API key</param>
        /// <param name="indicators">List of tracked indicators</param>
        [JsonConstructor]
        public TrackedIndicatorsResponse(Option<int?> count = default, Option<int?> maxTracked = default, Option<List<TrackedIndicator>> indicators = default)
        {
            CountOption = count;
            MaxTrackedOption = maxTracked;
        ...
        /// </summary>
        /// <value>Total number of tracked indicators</value>
        /* <example>5</example> */
        [JsonPropertyName("count")]
        public int? Count { get { return this.CountOption; } set { this.CountOption = new(value); } }

        /// <summary>
        /// Used to track the state of MaxTracked
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> MaxTrackedOption { get; private set; }

        /// <summary>
        /// Maximum number of indicators that can be tracked per API key
        /// </summary>
        /// <value>Maximum number of indicators that can be tracked per API key</value>
        /* <example>50</example> */
        [JsonPropertyName("max_tracked")]
        public int? MaxTracked { get { return this.MaxTrackedOption; } set { this.MaxTrackedOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<TrackedIndicator>> IndicatorsOption { get; private set; }

        /// <summary>
        /// List of tracked indicators
        /// </summary>
        /// <value>List of tracked indicators</value>
        [JsonPropertyName("indicators")]
        public List<TrackedIndicator> Indicators { get { return this.IndicatorsOption; } set { this.IndicatorsOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaxTracked: ").Append(MaxTracked).Append("\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedIndicatorsResponse" />
    /// </summary>
    public class TrackedIndicatorsResponseJsonConverter : JsonConverter<TrackedIndicatorsResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="TrackedIndicatorsResponse" />
        /// </summary>
        ...
        public override TrackedIndicatorsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<int?> maxTracked = default;
            Option<List<TrackedIndicator>> indicators = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "count":
                            ...
                            break;
                        case "max_tracked":
                            maxTracked = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "indicators":
                            indicators = new Option<List<TrackedIndicator>>(JsonSerializer.Deserialize<List<TrackedIndicator>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (count.IsSet && count.Value == null)
                throw new ArgumentNullException(nameof(count), "Property is not nullable for class TrackedIndicatorsResponse.");

            if (maxTracked.IsSet && maxTracked.Value == null)
                throw new ArgumentNullException(nameof(maxTracked), "Property is not nullable for class TrackedIndicatorsResponse.");

            if (indicators.IsSet && indicators.Value == null)
                throw new ArgumentNullException(nameof(indicators), "Property is not nullable for class TrackedIndicatorsResponse.");

            return new TrackedIndicatorsResponse(count, maxTracked, indicators);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedIndicatorsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedIndicatorsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedIndicatorsResponse trackedIndicatorsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedIndicatorsResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedIndicatorsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedIndicatorsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedIndicatorsResponse trackedIndicatorsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedIndicatorsResponse.IndicatorsOption.IsSet && trackedIndicatorsResponse.Indicators == null)
                throw new ArgumentNullException(nameof(trackedIndicatorsResponse.Indicators), "Property is required for class TrackedIndicatorsResponse.");

            if (trackedIndicatorsResponse.CountOption.IsSet)
                writer.WriteNumber("count", trackedIndicatorsResponse.CountOption.Value.Value);

            if (trackedIndicatorsResponse.MaxTrackedOption.IsSet)
                writer.WriteNumber("max_tracked", trackedIndicatorsResponse.MaxTrackedOption.Value.Value);

            if (trackedIndicatorsResponse.IndicatorsOption.IsSet)
            {
                writer.WritePropertyName("indicators");
                JsonSerializer.Serialize(writer, trackedIndicatorsResponse.Indicators, jsonSerializerOptions);
            }
        }
    }
}
