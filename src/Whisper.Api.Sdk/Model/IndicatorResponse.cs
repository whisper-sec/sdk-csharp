...
namespace Whisper.Api.Sdk.Model
{
    ...
    public class IndicatorResponseJsonConverter : JsonConverter<IndicatorResponse>
    {
        ...
        public override IndicatorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (routing.IsSet && routing.Value == null)
                throw new ArgumentNullException(nameof(routing), "Property is not nullable for class IndicatorResponse.");
            ...
            if (rpki.IsSet && rpki.Value == null)
                throw new ArgumentNullException(nameof(rpki), "Property is not nullable for class IndicatorResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, IndicatorResponse indicatorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (indicatorResponse.RoutingOption.IsSet && indicatorResponse.Routing == null)
                throw new ArgumentNullException(nameof(indicatorResponse.Routing), "Property is required for class IndicatorResponse.");
            ...
            if (indicatorResponse.RpkiOption.IsSet && indicatorResponse.Rpki == null)
                throw new ArgumentNullException(nameof(indicatorResponse.Rpki), "Property is required for class IndicatorResponse.");
