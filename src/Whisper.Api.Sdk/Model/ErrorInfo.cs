...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class ErrorInfo : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ErrorInfo(Option<string> code = default, Option<string> message = default)
        {
            CodeOption = code;
        ...
        /* <example>Job timed out after 5 minutes</example> */
    ...
    public class ErrorInfoJsonConverter : JsonConverter<ErrorInfo>
    {
        ...
        public override ErrorInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class ErrorInfo.");
        ...
        {
            if (errorInfo.CodeOption.IsSet && errorInfo.Code == null)
                throw new ArgumentNullException(nameof(errorInfo.Code), "Property is required for class ErrorInfo.");

            if (errorInfo.MessageOption.IsSet && errorInfo.Message == null)
                throw new ArgumentNullException(nameof(errorInfo.Message), "Property is required for class ErrorInfo.");

            if (errorInfo.CodeOption.IsSet)
                writer.WriteString("code", errorInfo.Code);

            if (errorInfo.MessageOption.IsSet)
                writer.WriteString("message", errorInfo.Message);
        }
    }
}
