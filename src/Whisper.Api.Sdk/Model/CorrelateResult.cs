...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class CorrelateResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CorrelateResult" /> class.
        /// </summary>
        /// <param name="indicators">List of indicators that were correlated</param>
        /// <param name="status">Status of the correlation analysis</param>
        /// <param name="error">Whether an error occurred</param>
        /// <param name="message">Error message if the correlation failed</param>
        /// <param name="correlation">correlation</param>
        [JsonConstructor]
        public CorrelateResult(Option<List<string>> indicators = default, Option<string> status = default, Option<bool?> error = default, Option<string> message = default, Option<Object> correlation = default)
        {
        ...
        /// </summary>
        /// <value>List of indicators that were correlated</value>
        ...
        /// </summary>
        /// <value>Status of the correlation analysis</value>
        ...
        /// </summary>
        /// <value>Error message if the correlation failed</value>
        [JsonPropertyName("message")]
        public string Message { get { return this.MessageOption; } set { this.MessageOption = new(value); } }

        /// <summary>
        /// Used to track the state of Correlation
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Object> CorrelationOption { get; private set; }

        /// <summary>
        /// Gets or Sets Correlation
        /// </summary>
        [JsonPropertyName("correlation")]
        public Object Correlation { get { return this.CorrelationOption; } set { this.CorrelationOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CorrelateResult" />
    /// </summary>
    public class CorrelateResultJsonConverter : JsonConverter<CorrelateResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="CorrelateResult" />
        /// </summary>
        ...
        public override CorrelateResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Object> correlation = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "message":
                            ...
                            break;
                        case "correlation":
                            correlation = new Option<Object>(JsonSerializer.Deserialize<Object>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (indicators.IsSet && indicators.Value == null)
                throw new ArgumentNullException(nameof(indicators), "Property is not nullable for class CorrelateResult.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class CorrelateResult.");

            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class CorrelateResult.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class CorrelateResult.");

            return new CorrelateResult(indicators, status, error, message, correlation);
        }

        /// <summary>
        /// Serializes a <see cref="CorrelateResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="correlateResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CorrelateResult correlateResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, correlateResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CorrelateResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="correlateResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CorrelateResult correlateResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (correlateResult.IndicatorsOption.IsSet && correlateResult.Indicators == null)
                throw new ArgumentNullException(nameof(correlateResult.Indicators), "Property is required for class CorrelateResult.");

            if (correlateResult.StatusOption.IsSet && correlateResult.Status == null)
                throw new ArgumentNullException(nameof(correlateResult.Status), "Property is required for class CorrelateResult.");

            if (correlateResult.MessageOption.IsSet && correlateResult.Message == null)
                throw new ArgumentNullException(nameof(correlateResult.Message), "Property is required for class CorrelateResult.");

            if (correlateResult.IndicatorsOption.IsSet)
            {
                writer.WritePropertyName("indicators");
                JsonSerializer.Serialize(writer, correlateResult.Indicators, jsonSerializerOptions);
            }
            if (correlateResult.StatusOption.IsSet)
                writer.WriteString("status", correlateResult.Status);

            if (correlateResult.ErrorOption.IsSet)
                writer.WriteBoolean("error", correlateResult.ErrorOption.Value.Value);

            if (correlateResult.MessageOption.IsSet)
                writer.WriteString("message", correlateResult.Message);

            if (correlateResult.CorrelationOption.IsSet)
                if (correlateResult.CorrelationOption.Value != null)
                {
                    writer.WritePropertyName("correlation");
                    JsonSerializer.Serialize(writer, correlateResult.Correlation, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("correlation");
        }
    }
}
