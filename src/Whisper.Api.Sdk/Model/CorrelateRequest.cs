...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class CorrelateRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="indicators">List of indicators (IPs, domains, hashes) to correlate across global threat intelligence. Maximum 100 indicators per request.</param>
        /// <param name="options">Optional configuration object for correlation analysis. NOT a string - must be an object with fields like timeWindow, minConfidence, etc.</param>
        [JsonConstructor]
        ...
        /// </summary>
        /// <value>List of indicators (IPs, domains, hashes) to correlate across global threat intelligence. Maximum 100 indicators per request.</value>
        /* <example>[8.8.8.8, evil.com, 1.2.3.4]</example> */
        ...
        /// </summary>
        /// <value>Optional configuration object for correlation analysis. NOT a string - must be an object with fields like timeWindow, minConfidence, etc.</value>
