...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class MonitoringStatusResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonitoringStatusResponse" /> class.
        /// </summary>
        /// <param name="target">The target domain or IP being monitored</param>
        /// <param name="status">Current monitoring status</param>
        /// <param name="metrics">Monitoring metrics and statistics</param>
        [JsonConstructor]
        public MonitoringStatusResponse(Option<string> target = default, Option<StatusEnum?> status = default, Option<MonitoringMetrics> metrics = default)
        {
            TargetOption = target;
            StatusOption = status;
        ...
        /// </summary>
        /// <value>Current monitoring status</value>
        ...
        /// </summary>
        /// <value>The target domain or IP being monitored</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<MonitoringMetrics> MetricsOption { get; private set; }

        /// <summary>
        /// Monitoring metrics and statistics
        /// </summary>
        /// <value>Monitoring metrics and statistics</value>
        [JsonPropertyName("metrics")]
        public MonitoringMetrics Metrics { get { return this.MetricsOption; } set { this.MetricsOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="MonitoringStatusResponse" />
    /// </summary>
    public class MonitoringStatusResponseJsonConverter : JsonConverter<MonitoringStatusResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="MonitoringStatusResponse" />
        /// </summary>
        ...
        public override MonitoringStatusResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MonitoringStatusResponse.StatusEnum?> status = default;
            Option<MonitoringMetrics> metrics = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<MonitoringStatusResponse.StatusEnum?>(MonitoringStatusResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "metrics":
                            metrics = new Option<MonitoringMetrics>(JsonSerializer.Deserialize<MonitoringMetrics>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (target.IsSet && target.Value == null)
                throw new ArgumentNullException(nameof(target), "Property is not nullable for class MonitoringStatusResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class MonitoringStatusResponse.");

            if (metrics.IsSet && metrics.Value == null)
                throw new ArgumentNullException(nameof(metrics), "Property is not nullable for class MonitoringStatusResponse.");

            return new MonitoringStatusResponse(target, status, metrics);
        }

        /// <summary>
        /// Serializes a <see cref="MonitoringStatusResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="monitoringStatusResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MonitoringStatusResponse monitoringStatusResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, monitoringStatusResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MonitoringStatusResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="monitoringStatusResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MonitoringStatusResponse monitoringStatusResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (monitoringStatusResponse.TargetOption.IsSet && monitoringStatusResponse.Target == null)
                throw new ArgumentNullException(nameof(monitoringStatusResponse.Target), "Property is required for class MonitoringStatusResponse.");

            if (monitoringStatusResponse.MetricsOption.IsSet && monitoringStatusResponse.Metrics == null)
                throw new ArgumentNullException(nameof(monitoringStatusResponse.Metrics), "Property is required for class MonitoringStatusResponse.");

            if (monitoringStatusResponse.TargetOption.IsSet)
                writer.WriteString("target", monitoringStatusResponse.Target);

            var statusRawValue = MonitoringStatusResponse.StatusEnumToJsonValue(monitoringStatusResponse.StatusOption.Value.Value);
            writer.WriteString("status", statusRawValue);
            if (monitoringStatusResponse.MetricsOption.IsSet)
            {
                writer.WritePropertyName("metrics");
                JsonSerializer.Serialize(writer, monitoringStatusResponse.Metrics, jsonSerializerOptions);
            }
        }
    }
}
