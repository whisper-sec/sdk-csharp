...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class BulkIpLocationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkIpLocationRequest" /> class.
        /// </summary>
        /// <param name="ips">List of IP addresses to lookup</param>
        [JsonConstructor]
        public BulkIpLocationRequest(List<string> ips)
        {
            Ips = ips;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>List of IP addresses to lookup</value>
        /* <example>[8.8.8.8, 1.1.1.1, 208.67.222.222]</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="BulkIpLocationRequest" />
    /// </summary>
    public class BulkIpLocationRequestJsonConverter : JsonConverter<BulkIpLocationRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="BulkIpLocationRequest" />
        /// </summary>
        ...
        public override BulkIpLocationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!ips.IsSet)
                throw new ArgumentException("Property is required for class BulkIpLocationRequest.", nameof(ips));

            if (ips.IsSet && ips.Value == null)
                throw new ArgumentNullException(nameof(ips), "Property is not nullable for class BulkIpLocationRequest.");

            return new BulkIpLocationRequest(ips.Value);
        }

        /// <summary>
        /// Serializes a <see cref="BulkIpLocationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bulkIpLocationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BulkIpLocationRequest bulkIpLocationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bulkIpLocationRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BulkIpLocationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bulkIpLocationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BulkIpLocationRequest bulkIpLocationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (bulkIpLocationRequest.Ips == null)
                throw new ArgumentNullException(nameof(bulkIpLocationRequest.Ips), "Property is required for class BulkIpLocationRequest.");

            writer.WritePropertyName("ips");
            JsonSerializer.Serialize(writer, bulkIpLocationRequest.Ips, jsonSerializerOptions);
        }
    }
}
