...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class ProgressInfo : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public ProgressInfo(Option<int?> current = default, Option<int?> total = default, Option<string> message = default)
        {
        ...
        /// </summary>
        /// <value>Current progress value</value>
        /* <example>5</example> */
        ...
        /// </summary>
        /// <value>Total expected progress value</value>
        /* <example>10</example> */
        ...
        /// Progress message
        /// </summary>
        /// <value>Progress message</value>
        /* <example>Processing indicators...</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProgressInfo" />
    /// </summary>
    public class ProgressInfoJsonConverter : JsonConverter<ProgressInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProgressInfo" />
        /// </summary>
        ...
        public override ProgressInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (current.IsSet && current.Value == null)
                throw new ArgumentNullException(nameof(current), "Property is not nullable for class ProgressInfo.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ProgressInfo.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class ProgressInfo.");

            return new ProgressInfo(current, total, message);
        }

        /// <summary>
        /// Serializes a <see cref="ProgressInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="progressInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProgressInfo progressInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, progressInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProgressInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="progressInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProgressInfo progressInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (progressInfo.MessageOption.IsSet && progressInfo.Message == null)
                throw new ArgumentNullException(nameof(progressInfo.Message), "Property is required for class ProgressInfo.");

            if (progressInfo.CurrentOption.IsSet)
                writer.WriteNumber("current", progressInfo.CurrentOption.Value.Value);

            if (progressInfo.TotalOption.IsSet)
                writer.WriteNumber("total", progressInfo.TotalOption.Value.Value);

            if (progressInfo.MessageOption.IsSet)
                writer.WriteString("message", progressInfo.Message);
        }
    }
}
