...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class ScreenshotRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ScreenshotRequest(string url, Option<ScreenshotOptions> options = default, Option<ScreenshotScheduleConfig> schedule = default)
        {
            Url = url;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ScreenshotScheduleConfig> ScheduleOption { get; private set; }
        ...
        public ScreenshotScheduleConfig Schedule { get { return this.ScheduleOption; } set { this.ScheduleOption = new(value); } }
    ...
    public class ScreenshotRequestJsonConverter : JsonConverter<ScreenshotRequest>
    {
        ...
        public override ScreenshotRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ScreenshotScheduleConfig> schedule = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "options":
                            ...
                            break;
                        case "schedule":
                            schedule = new Option<ScreenshotScheduleConfig>(JsonSerializer.Deserialize<ScreenshotScheduleConfig>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
