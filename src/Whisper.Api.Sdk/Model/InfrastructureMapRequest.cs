...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class InfrastructureMapRequest : IValidatableObject
    {
        ...
        {
            // StartPoint (string) minLength
            if (this.StartPoint != null && this.StartPoint.Length < 1)
            {
                yield return new ValidationResult("Invalid value for StartPoint, length must be greater than 1.", new [] { "StartPoint" });
            }
