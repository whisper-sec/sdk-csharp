...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class JobResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public JobResponse(Option<string> jobId = default, Option<string> status = default, Option<string> statusUrl = default, Option<string> message = default)
        {
            JobIdOption = jobId;
            StatusOption = status;
            StatusUrlOption = statusUrl;
        ...
        /// <summary>
        /// Used to track the state of StatusUrl
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string> StatusUrlOption { get; private set; }

        /// <summary>
        /// Gets or Sets StatusUrl
        /// </summary>
        [JsonPropertyName("status_url")]
        public string StatusUrl { get { return this.StatusUrlOption; } set { this.StatusUrlOption = new(value); } }
    ...
    public class JobResponseJsonConverter : JsonConverter<JobResponse>
    {
        ...
        public override JobResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new JobResponse(jobId, status, statusUrl, message);
        }
        ...
        {
            if (jobResponse.JobIdOption.IsSet && jobResponse.JobId == null)
                throw new ArgumentNullException(nameof(jobResponse.JobId), "Property is required for class JobResponse.");

            if (jobResponse.StatusOption.IsSet && jobResponse.Status == null)
                throw new ArgumentNullException(nameof(jobResponse.Status), "Property is required for class JobResponse.");

            if (jobResponse.StatusUrlOption.IsSet && jobResponse.StatusUrl == null)
            ...
            if (jobResponse.JobIdOption.IsSet)
                writer.WriteString("job_id", jobResponse.JobId);

            if (jobResponse.StatusOption.IsSet)
                writer.WriteString("status", jobResponse.Status);

            if (jobResponse.StatusUrlOption.IsSet)
                writer.WriteString("status_url", jobResponse.StatusUrl);
