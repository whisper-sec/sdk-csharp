...
namespace Whisper.Api.Sdk.Model
{
    ...
    /// </summary>
    public partial class LocationInfo : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="accuracyRadius">Accuracy radius in kilometers - actual location is within this radius</param>
        /// <param name="varTimeZone">IANA timezone identifier</param>
        [JsonConstructor]
        public LocationInfo(Option<double?> latitude = default, Option<double?> longitude = default, Option<int?> accuracyRadius = default, Option<string> varTimeZone = default)
        {
        ...
        /// </summary>
        /// <value>Accuracy radius in kilometers - actual location is within this radius</value>
        /* <example>20</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="LocationInfo" />
    /// </summary>
    public class LocationInfoJsonConverter : JsonConverter<LocationInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="LocationInfo" />
        /// </summary>
        ...
        public override LocationInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class LocationInfo.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class LocationInfo.");

            if (accuracyRadius.IsSet && accuracyRadius.Value == null)
                throw new ArgumentNullException(nameof(accuracyRadius), "Property is not nullable for class LocationInfo.");

            if (varTimeZone.IsSet && varTimeZone.Value == null)
                throw new ArgumentNullException(nameof(varTimeZone), "Property is not nullable for class LocationInfo.");

            return new LocationInfo(latitude, longitude, accuracyRadius, varTimeZone);
        }

        /// <summary>
        /// Serializes a <see cref="LocationInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="locationInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LocationInfo locationInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, locationInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LocationInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="locationInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, LocationInfo locationInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (locationInfo.VarTimeZoneOption.IsSet && locationInfo.VarTimeZone == null)
                throw new ArgumentNullException(nameof(locationInfo.VarTimeZone), "Property is required for class LocationInfo.");

            if (locationInfo.LatitudeOption.IsSet)
                writer.WriteNumber("latitude", locationInfo.LatitudeOption.Value.Value);

            if (locationInfo.LongitudeOption.IsSet)
                writer.WriteNumber("longitude", locationInfo.LongitudeOption.Value.Value);

            if (locationInfo.AccuracyRadiusOption.IsSet)
                writer.WriteNumber("accuracyRadius", locationInfo.AccuracyRadiusOption.Value.Value);

            if (locationInfo.VarTimeZoneOption.IsSet)
                writer.WriteString("timeZone", locationInfo.VarTimeZone);
        }
    }
}
