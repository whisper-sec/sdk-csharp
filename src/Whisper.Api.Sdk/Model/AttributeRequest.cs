...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class AttributeRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="indicators">List of indicators (IPs, domains, hashes, URLs) for attribution analysis. Maximum 500 indicators per request.</param>
        /// <param name="context">Optional context object to enhance attribution accuracy. NOT a string - must be an object with fields like observedTTPs, targetedSector, etc.</param>
        [JsonConstructor]
        ...
        /// </summary>
        /// <value>List of indicators (IPs, domains, hashes, URLs) for attribution analysis. Maximum 500 indicators per request.</value>
        /* <example>[8.8.8.8, evil.com, d41d8cd98f00b204e9800998ecf8427e]</example> */
        ...
        /// </summary>
        /// <value>Optional context object to enhance attribution accuracy. NOT a string - must be an object with fields like observedTTPs, targetedSector, etc.</value>
