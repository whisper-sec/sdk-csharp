...
namespace Whisper.Api.Sdk.Model
{
    ...
    public partial class RateLimitError : IValidatableObject
    {
        ...
        /// <param name="message">Human-readable error message with rate limit category</param>
        ...
        /// </summary>
        /// <value>Human-readable error message with rate limit category</value>
        /* <example>Rate limit exceeded for indicators. Please retry after 1 seconds.</example> */
        ...
        /// </summary>
        /// <value>Number of seconds to wait before retrying</value>
        /* <example>1</example> */
    ...
    public class RateLimitErrorJsonConverter : JsonConverter<RateLimitError>
    {
        ...
        public override RateLimitError Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!message.IsSet)
                throw new ArgumentException("Property is required for class RateLimitError.", nameof(message));

            if (!retryAfter.IsSet)
                throw new ArgumentException("Property is required for class RateLimitError.", nameof(retryAfter));
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class RateLimitError.");

            if (retryAfter.IsSet && retryAfter.Value == null)
                throw new ArgumentNullException(nameof(retryAfter), "Property is not nullable for class RateLimitError.");

            return new RateLimitError(error.Value, message.Value, retryAfter.Value.Value);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, RateLimitError rateLimitError, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (rateLimitError.Message == null)
                throw new ArgumentNullException(nameof(rateLimitError.Message), "Property is required for class RateLimitError.");

            writer.WriteString("error", rateLimitError.Error);

            writer.WriteString("message", rateLimitError.Message);

            writer.WriteNumber("retryAfter", rateLimitError.RetryAfter);
        }
    }
}
