...
namespace Whisper.Api.Sdk.Api
{
    ...
    /// </summary>
    public interface IGetIndicatorApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IOk<Whisper.Api.Sdk.Model.IndicatorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>, ITooManyRequests<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetIndicatorGraphApiResponse : Whisper.Api.Sdk.Client.IApiResponse, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 404 NotFound
        /// </summary>
    ...
    /// </summary>
    public interface IGetIndicatorHistoryApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IOk<Whisper.Api.Sdk.Model.HistoryResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 400 BadRequest
        /// </summary>
    ...
    /// </summary>
    public interface IGetPredictiveRiskApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IOk<Whisper.Api.Sdk.Model.PredictiveRiskResponse>
    {
        /// <summary>
        /// Returns true if the response is 400 BadRequest
        /// </summary>
    ...
    /// </summary>
    public interface IGetSubdomainsApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IOk<Whisper.Api.Sdk.Model.SubdomainResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 400 BadRequest
        /// </summary>
    ...
    public class IndicatorsApiEvents
    {
        ...
        internal void ExecuteOnGetPredictiveRisk(IndicatorsApi.GetPredictiveRiskApiResponse apiResponse)
        {
