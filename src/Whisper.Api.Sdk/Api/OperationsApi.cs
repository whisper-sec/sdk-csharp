...
namespace Whisper.Api.Sdk.Api
{
    ...
    /// </summary>
    public interface ICreateInfrastructureMapApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, IAccepted<Whisper.Api.Sdk.Model.JobResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface ICreateInfrastructureScanApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, IAccepted<Whisper.Api.Sdk.Model.JobResponse>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface ICreateMonitoringAlertApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IAccepted<Whisper.Api.Sdk.Model.JobResponse>
    {
        /// <summary>
        /// Returns true if the response is 400 BadRequest
        /// </summary>
    ...
    /// </summary>
    public interface ICreateScreenshotApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IAccepted<Whisper.Api.Sdk.Model.JobResponse>, ITooManyRequests<Whisper.Api.Sdk.Model.ErrorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IGetChangeDetectionApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetMonitoringStatusApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IGetScreenshotHistoryApiResponse : Whisper.Api.Sdk.Client.IApiResponse, IUnauthorized<Whisper.Api.Sdk.Model.ErrorResponse>, INotFound<Whisper.Api.Sdk.Model.ErrorResponse>, IBadRequest<Whisper.Api.Sdk.Model.ErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    public sealed partial class OperationsApi : IOperationsApi
    {
        ...
        public async Task<ICreateInfrastructureMapApiResponse> CreateInfrastructureMapAsync(InfrastructureMapRequest infrastructureMapRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                OnErrorCreateInfrastructureMapDefaultImplementation(e, "/v1/ops/map", uriBuilderLocalVar.Path, infrastructureMapRequest);
        ...
        public async Task<ICreateInfrastructureScanApiResponse> CreateInfrastructureScanAsync(ScanRequest scanRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                OnErrorCreateInfrastructureScanDefaultImplementation(e, "/v1/ops/scan", uriBuilderLocalVar.Path, scanRequest);
        ...
        public async Task<ICreateMonitoringAlertApiResponse> CreateMonitoringAlertAsync(string target, MonitoringAlertRequest monitoringAlertRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                OnErrorCreateMonitoringAlertDefaultImplementation(e, "/v1/ops/monitor/{target}/alert", uriBuilderLocalVar.Path, target, monitoringAlertRequest);
        ...
        public async Task<ISimilarDomainsApiResponse> SimilarDomainsAsync(SimilarDomainsOpsRequest similarDomainsOpsRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/v1/ops/similar-domains"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/v1/ops/similar-domains");
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/ops/similar-domains", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorSimilarDomainsDefaultImplementation(e, "/v1/ops/similar-domains", uriBuilderLocalVar.Path, similarDomainsOpsRequest);
