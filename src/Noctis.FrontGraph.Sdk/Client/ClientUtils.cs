...
[assembly: InternalsVisibleTo("Noctis.FrontGraph.Sdk.Test")]
...
namespace Noctis.FrontGraph.Sdk.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is DomainerAsyncRequestDTO.SimilarityTypeEnum domainerAsyncRequestDTOSimilarityTypeEnum)
                return DomainerAsyncRequestDTO.SimilarityTypeEnumToJsonValue(domainerAsyncRequestDTOSimilarityTypeEnum);
            if (obj is DomainerAsyncRequestDTO.OperatorEnum domainerAsyncRequestDTOOperatorEnum)
                return DomainerAsyncRequestDTO.OperatorEnumToJsonValue(domainerAsyncRequestDTOOperatorEnum);
            if (obj is DomainerAsyncRequestDTO.LevelEnum domainerAsyncRequestDTOLevelEnum)
                return DomainerAsyncRequestDTO.LevelEnumToJsonValue(domainerAsyncRequestDTOLevelEnum);
            if (obj is DomainerAsyncResultDTO.StatusEnum domainerAsyncResultDTOStatusEnum)
                return DomainerAsyncResultDTO.StatusEnumToJsonValue(domainerAsyncResultDTOStatusEnum);
            if (obj is DomainerAsyncResultDTO.OperatorEnum domainerAsyncResultDTOOperatorEnum)
                return DomainerAsyncResultDTO.OperatorEnumToJsonValue(domainerAsyncResultDTOOperatorEnum);
            if (obj is DomainerAsyncResultDTO.LevelEnum domainerAsyncResultDTOLevelEnum)
                return DomainerAsyncResultDTO.LevelEnumToJsonValue(domainerAsyncResultDTOLevelEnum);
            if (obj is DomainerSimilarityType domainerSimilarityType)
                return DomainerSimilarityTypeValueConverter.ToJsonValue(domainerSimilarityType);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://spider.noctisnet.com";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "spider.noctisnet.com";
